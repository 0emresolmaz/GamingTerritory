...
public class NVPExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(NVPDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new NVPStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static NVPDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static NVPDateTimeConverter dateTimeConverter = new NVPStandardDateTimeConverter();

    public NVPExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public NVPExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new NVPMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=NVPHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,NVPExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=NVPHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
