...
public class NVPKPSPublicSoap
{
    ...
    public NVPKPSPublicSoap(){}

    public NVPKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public NVPKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        NVPExtendedSoapSerializationEnvelope envelope= new NVPExtendedSoapSerializationEnvelope(NVPExtendedSoapSerializationEnvelope.VER11);
